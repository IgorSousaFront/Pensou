		...
		<header id="header">
			<div class="container">
				<div class="row">
					...
					<div class="header-button col-xs-3 visible-xs-inline-block">
					...
					<div class="col-xs-12 col-sm-9"  id="navbar">
						<nav class="header-navbar collapse navbar-collapse ">
							<ul>
								...
								<li class="btn"><a href="#" class="btn-primary">Orçamento</a></li>
							</ul>
						</nav>
					</div>
				</div>
...
<section id="service">
    <div class="container">
        ...
        <div class="row list-service text-center">
            <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="service-item">
                    <div class="bloco-img">
                        <img class="img-responsive" src="img/services-icon01.png">
                    </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="service-item">
                    <div class="bloco-img">
                        <img class="img-responsive" src="img/services-icon02.png">
                    </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="service-item">
                    <div class="bloco-img">
                        <img class="img-responsive" src="img/services-icon03.png">
                    </div>
                    <h3>SOLUÇOES PARA A INTERNET</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur.</p>
                </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="service-item">
                    <div class="bloco-img">
                        <img class="img-responsive" src="img/services-icon04.png">
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <a class="contato">+55 85 34912506</a>
                    <p class="info"><i class="fa fa-map-marker" aria-hidden="true"></i>  Rua Saudade 196 - Av. Expedicionários Montese- Fortaleza, CE </p>
                    <p class="info"><i class="fa fa-envelope" aria-hidden="true"></i>contato@pensouagencia.com.br</p>
                </div>
                <div class="col-md-6">
                    <div class="row">
